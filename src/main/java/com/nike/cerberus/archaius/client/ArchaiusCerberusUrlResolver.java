...
public class ArchaiusCerberusUrlResolver {
    ...
    private static final String INVALID_PROPERY_VALUE_TEMPLATE = "Could not find a valid value from the property %s";
     ...
     *
     * @param configuration an AbstractConfiguration used to get properties used to get
     *                      the Cerberus url from either the environment or system properties
     *
     * @return Cerberus URL
     */
    @Nullable
     ...
     */
    @Nullable
    private String checkPropertyRegionName(String testProperty, AbstractConfiguration configuration){
     ...
     *
     * @param configuration an AbstractConfiguration used to get properties used to get
     *                      region names from either the environment or system properties
     *
     * @return Cerberus region
     */
    public String resolveRegion(AbstractConfiguration configuration) {
        final String envRegion = checkPropertyRegionName(CERBERUS_REGION_ENV_PROPERTY, configuration);
        if(envRegion != null) {
            return envRegion;
        }

        final String sysRegion = checkPropertyRegionName(CERBERUS_REGION_SYS_PROPERTY, configuration);
        if(sysRegion != null) {
            return sysRegion;
        }
